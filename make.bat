...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=river-levels
SET SUPPORT_LIBRARY = river_levels
SET ENV_NAME=river-levels
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/river-levels*.tar.bz2
